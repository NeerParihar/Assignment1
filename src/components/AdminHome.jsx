...
const Ahome=()=>{
    ...
    return(
          ...
          <>
          <br/><h1 className="text-center text-white bg-secondary">Student Information Table</h1><br/>
          <pre>
            <form onSubmit={(e)=>{
              e.preventDefault();
              if(stud.id===''){
              ...
              <button className="btn btn-dark text-info">Add Data</button><span></span><br/><br/>
              <button className="btn btn-dark text-info">Update Data</button><br/><br/>
      
            </form>
          </pre>
          <input type="number" value={sid}  onChange={change}  placeholder="Enter id to search" /><br/><br/>
             <button className="btn btn-dark text-info" onClick={(e)=>{ 
          ...
          <button className="btn btn-dark text-info" onClick={show}>Show All Data</button><br/><br/>
